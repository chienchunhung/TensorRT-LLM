...
class NVLinkOneSided(Communication):
        ...
        if alltoall_watchdog_timeout_s is not None:
            ...
            self._alltoall_watchdog = AlltoAllWatchdog.from_workspace(
                ...
                metainfo_index={
                    ...
                    self.FLAG_VAL_OFFSET_INDEX,
                    "DISPATCH_COMPLETION_FLAGS_OFFSET_INDEX":
                    self.DISPATCH_COMPLETION_FLAGS_OFFSET_INDEX,
                    "COMBINE_COMPLETION_FLAGS_OFFSET_INDEX":
                    self.COMBINE_COMPLETION_FLAGS_OFFSET_INDEX,
                },
                ep_rank=self.ep_rank,
                ep_size=self.ep_size,
    ...
    def _read_current_flag_val(self) -> int:
        flag_val_offset = self.moe_a2a_metainfo[
            self.FLAG_VAL_OFFSET_INDEX].item()
