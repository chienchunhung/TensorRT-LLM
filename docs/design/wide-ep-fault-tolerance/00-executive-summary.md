...
- **Mode A** — signal-handler `MPI_Abort` propagation (Layer 1, MPI-specific). Verified at `mpiUtils.cpp:195–215`. Closes via signal handler replacement (PR 1d.0) under the FT feature flag.
