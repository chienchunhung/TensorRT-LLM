...
| 1a.7 | MVP | NCCL fault-tolerant wrapper + AllGatherReduceScatter mask wiring | [TRTLLM-12560](https://jirasw.nvidia.com/browse/TRTLLM-12560) | To Do | Unassigned | `A1_7`; [#15789](https://github.com/NVIDIA/TensorRT-LLM/pull/15789) |
...
| 1c.3 | MVP | MPI FT subcomm + broadcast thread | [TRTLLM-13548](https://jirasw.nvidia.com/browse/TRTLLM-13548) | To Do | Unassigned | `C1_3`; [#15785](https://github.com/NVIDIA/TensorRT-LLM/pull/15785) |
...
| 1d.3 | MVP | Per-rank health telemetry / metrics | [TRTLLM-13553](https://jirasw.nvidia.com/browse/TRTLLM-13553) | To Do | Unassigned | `D1_3`; [#15788](https://github.com/NVIDIA/TensorRT-LLM/pull/15788) |
