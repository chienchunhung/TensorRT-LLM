...
flowchart LR
    ...
    subgraph MVP_ANCHORS["MVP prerequisite anchors"]
        ...
        M_A7["MVP 1a.7 · NCCL FT wrapper<br/>PR: #15789 · draft · blossom-ci failed<br/>JIRA: TRTLLM-12560<br/>★ dependency-ready action"]
    ...
    linkStyle 0,1,2,3,4,5,6,7,9,13,14,16,17,18,19,20,21,22,23,24 stroke:#dc2626,stroke-width:3px;
    linkStyle 8,10,11,15 stroke:#16a34a,stroke-width:3px;
...
None of the V1, Phase 1-DS, or Phase 1-IB implementation nodes qualify yet. Every implementation path has an unsatisfied MVP release/component dependency, shown by at least one red ancestral edge. The merged #13404 component edges into 1a.5 and 1a.8 and the #15525 component edge into 1b.4 are green, but the global MVP release edges still block those V1 nodes. Gold prerequisite anchors are dependency-ready **MVP** actions reused here, not V1 candidates. Audit and external-integration gates may proceed as preparatory work, but they are not PR action-frontier nodes.
...
- Reused MVP anchors reflect the live delivery state: #13404 and #15525 are merged, while #15789 and #15785 are draft PRs. Only merged anchors turn their outgoing component edge green.
